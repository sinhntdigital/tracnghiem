...
class QuizController extends Controller
{
    ...
    public function index($examId){
    	$questions=\App\User::join('role_user','users.id','=','role_user.user_id')->join('roles','roles.id','=','role_user.role_id')->join('user_exams','users.id','=','user_exams.user_id')->join('exams','exams.id','=','user_exams.exam_id')->leftjoin('questions','exams.id','=','questions.exam_id')->join('content_answers','questions.id','=','content_answers.question_id')->where('role_user.user_id',Auth::user()->id)->where('exams.id','=',$examId)->groupBy('question_id')->paginate(1);
        $answers=\App\User::join('role_user','users.id','=','role_user.user_id')->join('roles','roles.id','=','role_user.role_id')->join('user_exams','users.id','=','user_exams.user_id')->join('exams','exams.id','=','user_exams.exam_id')->leftjoin('questions','exams.id','=','questions.exam_id')->join('content_answers','questions.id','=','content_answers.question_id')->leftjoin('user_answers','content_answers.id','=','user_answers.content_answer_id')->where('role_user.user_id',Auth::user()->id)->where('exams.id','=',$examId)->select('*','content_answers.id as content_answer_id')->get();
    ...
    public function listQuiz() {
    	$listQuizs=\App\Exam::join('user_exams','user_exams.exam_id','=','exams.id')->where('user_exams.user_id', Auth::user()->id)->get();
    ...
    public function result($examId){
        ...
        $questions=\App\User::join('role_user','users.id','=','role_user.user_id')->join('roles','roles.id','=','role_user.role_id')->join('user_exams','users.id','=','user_exams.user_id')->join('exams','exams.id','=','user_exams.exam_id')->leftjoin('questions','exams.id','=','questions.exam_id')->join('content_answers','questions.id','=','content_answers.question_id')->leftjoin('user_answers','content_answers.id','=','user_answers.content_answer_id')->where('role_user.user_id',Auth::user()->id)->where('exams.id','=',$examId)->groupBy('question_id')->select('*','content_answers.id as content_answer_id')->get();

        $results=\App\User::join('role_user','users.id','=','role_user.user_id')->join('roles','roles.id','=','role_user.role_id')->join('user_exams','users.id','=','user_exams.user_id')->join('exams','exams.id','=','user_exams.exam_id')->leftjoin('questions','exams.id','=','questions.exam_id')->join('content_answers','questions.id','=','content_answers.question_id')->leftjoin('user_answers','content_answers.id','=','user_answers.content_answer_id')->where('role_user.user_id',Auth::user()->id)->where('exams.id','=',$examId)->where('answer','=',1)->select('*','content_answers.id as content_answer_id')->get();
         $resultOfYous=\App\User::join('role_user','users.id','=','role_user.user_id')->join('roles','roles.id','=','role_user.role_id')->join('user_exams','users.id','=','user_exams.user_id')->join('exams','exams.id','=','user_exams.exam_id')->leftjoin('questions','exams.id','=','questions.exam_id')->join('content_answers','questions.id','=','content_answers.question_id')->leftjoin('user_answers','content_answers.id','=','user_answers.content_answer_id')->where('role_user.user_id',Auth::user()->id)->where('exams.id','=',$examId)->where('user_answer','=',1)->select('*','content_answers.id as content_answer_id')->get();
