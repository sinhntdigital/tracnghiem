...
@section('page_content')
	<a href="{{route('exam.create')}}" class="btn btn-info" style="float: right;margin-bottom: 20px;">Thêm đề thi</a>
	...
	$(function() {
	    $('#users-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{!! route("datatables_exam") !!}',
	        columns: [
	            { data: 'eid', name: 'eid' },
	            { data: 'title_exam', name: 'title_exam' },
